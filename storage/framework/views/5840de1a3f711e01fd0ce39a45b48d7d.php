...
$all_subject_ids = $subjects ? $subjects->pluck('subject_id')->toArray() : [];
...
<?php if(isset($is_result_available)): ?>
                                            ...
                                            <div class="card-header">
                                                    <div class="d-flex">
                                                            ...
                                                            <div class="col-lg-6 ml-30">
                                                                ...
                                                                <p class="text-white mb-0">
                                                                    <?php echo app('translator')->get('common.email'); ?>:  <?php echo e(isset(generalSetting()->email)?generalSetting()->email:'admin@demo.com'); ?>,   <?php echo app('translator')->get('common.phone'); ?>:  <?php echo e(isset(generalSetting()->phone)?generalSetting()->phone:'+8801841412141'); ?> 
                                                                </p> 
                                                            </div>
                                                            <div class="offset-2">
                                                            </div>
                                                        ...
                                                        <tbody class="mark_sheet_body">
                                                            ...
                                                            <tfoot>
                                                                  <tr>
                                                                        ...
                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                        <th class="text-center"><?php echo e(!empty($all_subject_ids) ? allExamSubjectMarkAverage($record_id, $all_subject_ids) : 0); ?></th>
                                                                        ...
                                                                        <th class="text-center"><?php echo e(!empty($all_subject_ids) ? getGrade(allExamSubjectMarkAverage($record_id, $all_subject_ids), true) : 'N/A'); ?></th>
    ...
    <?php endif; ?>
<?php endif; ?><?php /**PATH C:\inetpub\vhosts\abouhamad.net\portal.Alsadeq-Academy.com\public\resources\views/backend/studentInformation/inc/finalMarkSheet.blade.php ENDPATH**/ ?>