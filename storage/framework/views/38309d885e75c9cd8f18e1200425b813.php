                                                        ...
                                                        <?php if(isMenuAllowToShow('dormitory')): ?>
                                                            <?php if(is_show('dormitory_name') || is_show('room_number')): ?>
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        <div class="main-title">
                                                                            <h4 class="stu-sub-head"><?php echo app('translator')->get('student.Other_info'); ?>
                                                                            </h4>
                                                                        </div>
                                                                    </div>
                                                                </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\abouhamad.net\portal.Alsadeq-Academy.com\public\resources\views/backEnd/studentInformation/student_admission.blade.php ENDPATH**/ ?>