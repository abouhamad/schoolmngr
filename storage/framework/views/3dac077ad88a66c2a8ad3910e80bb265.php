                            ...
                            <div id="collapseOne" class="collapse <?php echo e(isset($editPermissionSection) ? 'show':''); ?>" aria-labelledby="headingOne" data-parent="#accordion">
                                <div class="card-body">
                                   ...
                                   <?php echo Form::open(['route'=>'sidebar-manager.section-update', 'method'=>'POST']); ?>
                                    ...
                                    <?php else: ?>
                                    <?php echo Form::open(['route'=>'sidebar-manager.section.store', 'method'=>'POST']); ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\abouhamad.net\portal.Alsadeq-Academy.com\public\Modules/MenuManage\Resources/views/index.blade.php ENDPATH**/ ?>