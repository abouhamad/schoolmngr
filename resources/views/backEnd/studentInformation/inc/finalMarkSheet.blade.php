                                                        ...
                                                        <tbody class="mark_sheet_body">
                                                            ...
                                                            <tfoot>
                                                                  <tr>
                                                                        ...
                                                                        @endforeach
                                                                        <th class="text-center">{{ !empty($all_subject_ids) ? allExamSubjectMarkAverage($record_id, $all_subject_ids) : 0 }}</th>
                                                                        ...
                                                                        <th class="text-center">{{ !empty($all_subject_ids) ? getGrade(allExamSubjectMarkAverage($record_id, $all_subject_ids), true) : 'N/A' }}</th>
