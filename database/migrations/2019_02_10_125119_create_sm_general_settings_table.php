...
class CreateSmGeneralSettingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('sm_general_settings', function (Blueprint $table) {
            ...
            $table->string('system_version')->nullable()->default('9.0');
            ...
            $table->string('session_year')->nullable()->default('2024');
            ...
            $table->tinyInteger('preloader_type')->default(2);
        ...
        DB::table('sm_general_settings')->insert([
            [
                'copyright_text' => 'Copyright &copy; 2024 All rights reserved | This application is made by eSkooly Inc.',
                'logo' => 'public/uploads/settings/logo.png',
                'favicon' => 'public/uploads/settings/favicon.png',
                'phone' => '+923460204447',
                'school_code' => '12345678',
                'email' => 'info@eskooly.com',
                'address' => '1092 Chester Road Stretford, Manchester UK',
                'currency' => 'USD',
                'currency_symbol' => '$',
                'school_name' => 'eSkooly Pro',
                'site_title' => 'eSkooly Education software',
                'session_id' => 1,
                'week_start_id' => 3,
                'time_zone_id' => 51,
